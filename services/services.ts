...
export class Services {
    ...
    async createConversation(categoryId: number, studentId: number, counselorId: number): Promise<Conversation> {
    ...
    async createCounselor(firstName: string, lastName: string, email: string, skillCategories: Array<number>): Promise<Counselor> {
    ...
    async createCounselorSkills(counselorId: number, categorySkills: Array<number>): Promise<Array<CounselorSkill>> {
