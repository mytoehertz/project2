...
function getValidationOnlyOptions(options) {
    return Object.assign({}, options, { database: '_name_', username: '_username_', password: '_password_', dialect: 'sqlite', dialectModulePath: __dirname + '/../validation-only/db-dialect-dummy' });
}
/**
